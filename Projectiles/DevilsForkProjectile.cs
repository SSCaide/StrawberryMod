...
{
    public class DevilsForkProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Vector2 muzzleOffset = Vector2.Normalize(projectile.velocity) * 40f;
			...
			if (!projOwner.frozen)
			{
				...
				{
					movementFactor = 8f; // Make sure the spear moves forward when initially thrown out
